...
const css = {
  code: "main.s-RZ0VQ2Z32vDr.s-RZ0VQ2Z32vDr{display:grid;place-items:center;height:calc(100vh - 35px)}#thanksContainer.s-RZ0VQ2Z32vDr.s-RZ0VQ2Z32vDr{width:85%;margin-top:15vh}#thanks.s-RZ0VQ2Z32vDr.s-RZ0VQ2Z32vDr{font-size:500%;font-weight:600}#contact.s-RZ0VQ2Z32vDr a.s-RZ0VQ2Z32vDr{color:#ffcc01}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<main class="s-RZ0VQ2Z32vDr"><section id="thanksContainer" class="s-RZ0VQ2Z32vDr"><p id="thanks" class="s-RZ0VQ2Z32vDr" data-svelte-h="svelte-mqrabe">Thank you to our sponsors</p> <p id="contact" class="s-RZ0VQ2Z32vDr">If you&#39;d like to sponsor us, please contact us <a href="../Contact" class="s-RZ0VQ2Z32vDr" data-svelte-h="svelte-vcc9cr">here</a></p></section> ${validate_component(Carousel, "Carousel").$$render(
    $$result,
    {
      components: [
